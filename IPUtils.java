...
public class IPUtils {
    ...
    interface IPMinMax {
        ...
        int MAX_IP_V4_POINT = 2 ^ 8 - 1;
        int MIN_IP_V6_POINT = 0;
        int MAX_IP_V6_POINT = 2 ^ 16 - 1;
    }
    ...
    public static String hexToBin(String hex) {
        ...
        return completeChar(4 - bin.length(), "0");
    }
    ...
    public static boolean isIpv6(String ipAddr) {
        ...
        return testRegex(Regex.IP_V6_RGX, ipAddr);
    }
     ...
     * IPV4 网段转换数字
     */
    public static long[] getIpv4SegmentRange(String ipv4Seg) {
        String[] ipArr = ipv4Seg.split("~");
        if (ipArr.length != 2 || !isIpv4(ipArr[0]) || !isIpv6(ipArr[1])) {
            return null;
        }
        return new long[] {convertIpv4ToLong(ipArr[0]), convertIpv4ToLong(ipArr[1])};
    }

    /**
     * IPV4子网转换数字
     */
    public static long[] getIpv4SubnetRange(String ipv4Subnet) {
